...
export const blogIdValidation = body('blogId').isString().withMessage('Incorrect blogId!')
...
export const blogPostValidation = () => [blogIdValidation, titleValidation, shortDescriptionValidation, contentValidation, inputValidation]
